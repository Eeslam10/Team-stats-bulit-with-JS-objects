...
const team = {
    _players: [
      ...
      {firstName: 'stephen', lastName: 'curry', age: 27},
      {firstName: 'micheal', lastName: 'jordan', age: 45}
    ],
    _games: [
      {opponent: 'lakers', teamPoints: 121, opponentPoints: 109},
      {opponent: 'golden', teamPoints: 98, opponentPoints: 132},
      {opponent: 'stars', teamPoints: 147, opponentPoints: 71}
    ],
